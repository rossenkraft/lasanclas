...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const messages = [
"¿Necesitás una marca con rumbo claro?",
"¿Tu marca perdió el rumbo y ya no sabés hacia dónde navegar?",
"¿Sentís que tu identidad ya no refleja lo que tu negocio es hoy?",
"¿Tu marca sigue flotando, pero sin avanzar?",
"¿Tus ventas bajan y no entendés si el problema es el mensaje o la estrategia?",
"¿Tu marca dejó de atraer al público correcto?",
"¿Estás compitiendo en un mar lleno de iguales sin saber cómo destacar?",
"¿Tu comunicación se ve bien, pero no genera resultados reales?",
"¿Sentís que tu marca se quedó anclada en el pasado?",
"¿Tu negocio cambió, pero tu marca no lo acompañó?",
"¿Tenés una identidad visual, pero no una dirección clara?",
"¿El viento cambió y tu marca apunta al puerto equivocado?",
"¿Tu propuesta ya no resuena con tu audiencia?",
"¿Tu estrategia parece más improvisación que navegación planificada?",
"¿Te cuesta mantener coherencia entre lo que mostrás y lo que hacés?",
"¿Tu marca se ve activa, pero sin propósito claro?",
"¿Estás remando contra la corriente del mercado sin resultados?",
"¿Tu competencia avanza y vos seguís ajustando velas?",
"¿Sentís que tus clientes ya no conectan con el valor real de tu marca?",
"¿Tu marca comunica, pero no convence?",
"¿Necesitás una nueva carta de navegación para recuperar dirección y crecimiento?",
  ];
